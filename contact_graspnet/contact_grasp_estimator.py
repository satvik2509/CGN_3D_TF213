...
class GraspEstimator:
    ...
    def __init__(self, cfg):
        ...
        # Use the trained network input size so restored checkpoint variable
        # shapes and inference graph topology remain unchanged.
        self._num_input_points = self._contact_grasp_cfg['DATA']['num_point']
