...
class SamplingGpuOnlyCpuOp : public OpKernel {
  public:
    explicit SamplingGpuOnlyCpuOp(OpKernelConstruction* context):OpKernel(context){}
    void Compute(OpKernelContext* context) override {
      OP_REQUIRES(context, false,
                  errors::Unimplemented("PointNet++ sampling ops require a CUDA GPU kernel."));
    }
};
...
REGISTER_KERNEL_BUILDER(Name("ProbSample").Device(DEVICE_CPU), SamplingGpuOnlyCpuOp);
...
REGISTER_KERNEL_BUILDER(Name("FarthestPointSample").Device(DEVICE_CPU), SamplingGpuOnlyCpuOp);
...
REGISTER_KERNEL_BUILDER(Name("GatherPoint").Device(DEVICE_CPU), SamplingGpuOnlyCpuOp);
...
REGISTER_KERNEL_BUILDER(Name("GatherPointGrad").Device(DEVICE_CPU), SamplingGpuOnlyCpuOp);
