...
class GroupingGpuOnlyCpuOp : public OpKernel {
    public:
        explicit GroupingGpuOnlyCpuOp(OpKernelConstruction* context) : OpKernel(context) {}
        void Compute(OpKernelContext* context) override {
            OP_REQUIRES(context, false,
                        errors::Unimplemented("PointNet++ grouping ops require a CUDA GPU kernel."));
        }
};
...
REGISTER_KERNEL_BUILDER(Name("QueryBallPoint").Device(DEVICE_CPU), GroupingGpuOnlyCpuOp);
...
REGISTER_KERNEL_BUILDER(Name("SelectionSort").Device(DEVICE_CPU), GroupingGpuOnlyCpuOp);
...
REGISTER_KERNEL_BUILDER(Name("GroupPoint").Device(DEVICE_CPU), GroupingGpuOnlyCpuOp);
...
REGISTER_KERNEL_BUILDER(Name("GroupPointGrad").Device(DEVICE_CPU), GroupingGpuOnlyCpuOp);
